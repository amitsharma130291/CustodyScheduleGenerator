...
const schedule: ScheduleContent = {
	...
	metaTitle: 'Every Other Weekend Custody Schedule | CustodyBuilder',
	metaDescription: 'Create an every other weekend custody schedule, preview visitation calendar examples, estimate parenting time, and print a plan to share online.',
