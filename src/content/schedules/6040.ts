...
const schedule: ScheduleContent = {
	...
	metaTitle: '60/40 Custody Schedule Calendar & Guide | CustodyBuilder',
	metaDescription: 'Create a 60/40 custody schedule, compare common arrangements, estimate parenting time, and print a custody calendar for co-parenting online.',
