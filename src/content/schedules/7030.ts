...
const schedule: ScheduleContent = {
	...
	metaTitle: '70/30 Custody Schedule | Examples & Parenting Time',
	metaDescription: 'Compare 70/30 custody schedule examples, including every other weekend arrangements, and calculate parenting time.',
