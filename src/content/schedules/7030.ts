...
const schedule: ScheduleContent = {
	...
	metaTitle: '70/30 Custody Schedule Calendar & Guide | CustodyBuilder',
	metaDescription: 'Build a 70/30 custody schedule, compare majority-time plans, preview a calendar, and print a clear parenting schedule for review online now.',
