...
export const canHelp = {
	...
	items: [
		...
		{ heading: 'Schedule export problems', body: 'Print layout issues, missing parent labels, or color key errors on exported calendars.' },
		{ heading: 'Correction requests', body: 'Factual errors in guide copy, broken internal links, outdated examples, or FAQ/schema mismatch.' },
		{ heading: 'Editorial feedback', body: 'Suggestions for clearer operational language, missing boundary links, or cluster overlap concerns.' },
	],
};

export const cannotHelp = {
	title: 'What We Cannot Help With',
	items: [
		{ heading: 'Legal advice', body: 'We do not interpret orders, recommend court strategy, or predict outcomes.' },
		{ heading: 'Case-specific schedule recommendations', body: 'We do not review individual parenting situations or tell parents which schedule a judge should order.' },
		{ heading: 'Child support legal determinations', body: 'Texas support estimates are planning math only — not binding support orders.' },
		{ heading: 'Medical or therapeutic guidance', body: 'Age guides discuss logistics — not child development prescriptions.' },
	],
};

export const beforeContact = {
	title: 'Before You Contact Us',
	intro: 'These pages answer most product questions without a reply.',
	links: [
		{ label: 'How CustodyBuilder works', href: '/how-custodybuilder-works/', detail: 'Methodology and review standards' },
		{ label: 'Custody schedule generator', href: '/custody-schedule-generator/', detail: 'Calendar building' },
		{ label: 'Custody percentage calculator', href: '/custody-percentage-calculator/', detail: 'Overnight percentage math' },
		{ label: 'Parenting plan template', href: '/parenting-plan-template/', detail: 'Agreement clause outline' },
	],
};
