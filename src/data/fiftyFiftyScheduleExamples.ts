...
export const monthlyCalendarExamples = [
	...
	},
	{
		...
		description:
			'See how a 5-2-2-5 rotation assigns a full school-week block to one parent — homework, Tuesday soccer, Thursday piano — before a two-day bridge and the pattern flips.',
		exchanges: 'Approximately 3 per two weeks',
		longestAway: '5 days',
		bestFor: 'School-age children when one parent should own consecutive school nights and recurring weekday activities',
		highlights: ['Five-day school-week ownership blocks', 'Fewer midweek handoffs than 2-2-3', 'Monday-start plans often keep one parent on every Mon–Tue'],
...
export const scheduleTypeExamples = [
	...
	},
	{
		...
		bestFor: 'This 5-2-2-5 example fits school-age children when one parent should own a full Mon–Fri school stretch — homework, Tuesday practice, Thursday lessons — before the two-week rhythm flips.',
		pattern: pattern5225,
		exchanges: 'About 2 exchanges every two weeks, often tied to school dismissal.',
		pros: ['One parent owns five consecutive school nights', 'Recurring weekday activities can follow block ownership', 'Fewer midweek handoffs than 2-2-3'],
		challenges: ['Five-day stretches can feel long for younger kids', 'Short two-day blocks may fill with tournament travel', 'Holiday overrides need clear written rules'],
		scheduleId: '5225',
		guideHref: '/5-2-2-5-custody-schedule/',
		guideLabel: '5-2-2-5 school-week block guide',
		metrics: { exchangeLevel: 'Medium', predictability: 'High', bestAge: 'School-age children' },
	},
	{
...
export const decisionRows = [
	...
	{
		situation: 'Recurring weekday activities (soccer, piano, tutoring)',
		example: '5-2-2-5 with Monday start',
		why: 'One parent can own a full school-week block and often keeps fixed Mon–Tue duties, so Tuesday practice has a default driver.',
		scheduleId: '5225',
	},
	{
...
export const relatedLinks = [
	...
	{ title: '5-2-2-5 Schedule', href: '/5-2-2-5-custody-schedule/', description: 'School-week block ownership — homework, activities, and weekday parent duties.' },
